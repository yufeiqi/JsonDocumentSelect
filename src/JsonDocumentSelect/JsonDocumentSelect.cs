...
{
    internal class JsonDocumentSelect
    {
        ...
        public JsonDocumentSelect(string expression)
        {
        ...
        private bool ParsePath(List<PathFilter> filters, int currentPartStartIndex, bool query)
        {
            ...
            {
                currentPartStartIndex = CurrentPartStartIndex(filters, currentPartStartIndex, query, ref scan,
                    ref followingIndexer, ref followingDot, ref ended);
            }
            ...
            else if (followingDot && (atPathEnd || query))
            {
        ...
        private int CurrentPartStartIndex(List<PathFilter> filters, int currentPartStartIndex, bool query, ref bool scan,
            ref bool followingIndexer, ref bool followingDot, ref bool ended)
        {
        ...
        private static JsonElement SafeValue(object value)
        {
            if (value == null)
            {
